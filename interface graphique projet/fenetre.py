...
screen.title("Projet scout")
heading = Label(text = "Inscription", bg = "grey", fg = "black", width = "500", height = "3")
heading.pack()

 
firstname_text = Label(text = "Prénom * ",)
lastname_text = Label(text = "Nom * ",)
...
register = Button(screen,text = "Enregistrer", width = "30", height = "2", command = save_info, bg = "grey")
